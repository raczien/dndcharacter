...
class _AttributesState extends State<Attributes> {
  int cb0 = CharacterSheet.boni.isEmpty ? 0 : CharacterSheet.boni[0];
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                'VB: +${CharacterSheet.boni.isEmpty ? 0 : CharacterSheet.boni[0]}',
                                style: titleStyle,
                                overflow: TextOverflow.ellipsis,
                              ),
                            ),
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(2.0),
                              child: Text(
                                'VB: +${CharacterSheet.boni.isEmpty ? 0 : CharacterSheet.boni[1]}',
                                style: titleStyle,
                                overflow: TextOverflow.ellipsis,
                              ),
                            ),
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(2.0),
                              child: Text(
                                'VB: +${CharacterSheet.boni.isEmpty ? 0 : CharacterSheet.boni[2]}',
                                style: titleStyle,
                                overflow: TextOverflow.ellipsis,
                              ),
                            ),
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(2.0),
                              child: Text(
                                'VB: +${CharacterSheet.boni.isEmpty ? 0 : CharacterSheet.boni[3]}',
                                style: titleStyle,
                                overflow: TextOverflow.ellipsis,
                              ),
                            ),
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(2.0),
                              child: Text(
                                'VB: +${CharacterSheet.boni.isEmpty ? 0 : CharacterSheet.boni[4]}',
                                style: titleStyle,
                                overflow: TextOverflow.ellipsis,
                              ),
                            ),
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(2.0),
                              child: Text(
                                'VB: +${CharacterSheet.boni.isEmpty ? 0 : CharacterSheet.boni[5]}',
                                style: titleStyle,
                                overflow: TextOverflow.ellipsis,
                              ),
                            ),
            ...
            if (everythingSet())
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  CharacterSheet.attributesSet = true;
